package com.leanplatform.MentorshipPlatform.repositories.EventTypeRepository;
...
public interface EventTypesRepository extends JpaRepository<EventType, UUID> {
   ...
   EventType findByEventId(@Param("eventId")UUID eventId);
   ...
   // EventType findByEventId(UUID eventTypeId);
}
